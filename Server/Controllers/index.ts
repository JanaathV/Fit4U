...
export function DisplayContactUsPage(req: Request, res: Response, next: NextFunction): void
{
    res.render('index', { title: 'Contact Us Page', page: 'contactus',  displayName: UserDisplayName(req)  });
}
